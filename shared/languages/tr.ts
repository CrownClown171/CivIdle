export const TR = {
   ...
   YangtzeRiverDesc: "Su tüketen tüm binalar +1 Üretim, İşçi kapasitesi ve Depolama Çarpanı kazanır. Double the effect of Zheng He (Great Person). Each level of Permanent Empress Wu Zetian (Great Person) provides +1 Storage Multiplier to all buildings",
   YellowCraneTower: "Sarı Turna Kulesi",
   YellowCraneTowerDesc: "Büyük İnsan seçimi sırasında +1 seçim hakkı. 1 karo içindeki tüm binalar +1 Üretim, Depolama ve İşçi Çarpanı kazanır. Yangtze Nehri'nin yanına inşa edildiğinde menzil 2 karoya çıkar.",
   YuriGagarin: "Yuri Gagarin",
   ZagrosMountains: "Zagros Dağları",
   ZagrosMountainsDesc: "Üretim çarpanı 5'ten az olan bitişik binalar +2 Üretim Çarpanı kazanır. II. Nebukadnezar'ın (Büyük İnsan) etkisini 2 katına çıkarır.",
   ZahaHadid: "Zaha Hadid",
   ZahaHadidDesc: "+%{value} Builder Capacity Multiplier",
   Zenobia: "Zenobia",
   ZenobiaDesc: "+%{value}s Petra Warp Deposu",
   ZhengHe: "Zheng He",
   ZigguratOfUr: "Ur'un Ziggurat'ı",
